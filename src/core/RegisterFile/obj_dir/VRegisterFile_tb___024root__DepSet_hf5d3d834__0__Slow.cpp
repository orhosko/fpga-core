...
VL_ATTR_COLD void VRegisterFile_tb___024root___ctor_var_reset(VRegisterFile_tb___024root* vlSelf) {
    ...
    vlSelf->RegisterFile_tb__DOT__write_sel = VL_RAND_RESET_I(5);
    vlSelf->RegisterFile_tb__DOT__read_selA = VL_RAND_RESET_I(5);
    vlSelf->RegisterFile_tb__DOT__read_selB = VL_RAND_RESET_I(5);
    vlSelf->RegisterFile_tb__DOT__data_in = VL_RAND_RESET_I(32);
    vlSelf->RegisterFile_tb__DOT__write_en = VL_RAND_RESET_I(1);
    vlSelf->RegisterFile_tb__DOT__data_outA = VL_RAND_RESET_I(32);
    vlSelf->RegisterFile_tb__DOT__data_outB = VL_RAND_RESET_I(32);
